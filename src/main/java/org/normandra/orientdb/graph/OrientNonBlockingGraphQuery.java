...
import org.normandra.orientdb.data.OrientNonBlockingListener;

import java.util.*;

public class OrientNonBlockingGraphQuery implements Iterable<OrientElement> {
    private final OrientGraph database;
    ...
    public OrientNonBlockingGraphQuery(final OrientGraph db, final String query, final Collection<?> params) {
        if (null == db) {
    ...
    public OrientNonBlockingGraphQuery(final OrientGraph db, final String query, final Map<String, Object> params) {
        if (null == db) {
            throw new NullArgumentException("database");
        }
        if (null == query) {
    ...
    @Override
    public Iterator<OrientElement> iterator() {
        return this.execute();
    }
