...
public class OrientEdge<T> implements Edge<T> {
    ...
    @Override
    public Node getStart() throws NormandraException {
        return this.buildNode(this.edge.getOutVertex());
    }

    @Override
    public Node getEnd() throws NormandraException {
        return this.buildNode(this.edge.getInVertex());
    }

    @Override
    public Node getOtherNode(final Node node) throws NormandraException {
        final Node start = this.getStart();
        if (null == start) {
            return node;
        }
    ...
    private OrientNode buildNode(final OIdentifiable rid) {
        if (null == rid) {
            return null;
        }

        final ODocument document = rid.getRecord();
        if (null == document) {
            return null;
        }
    ...
    @Override
    public void updateEntity(final T entity) throws NormandraException {
